...
__decorate([
    (0, typeorm_1.ManyToOne)(() => cart_1.Cart, cart => cart.cItem, { onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'cartid' }),
    __metadata("design:type", cart_1.Cart)
], CartItem.prototype, "cartid", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => product_1.Product, prod => prod.cItem, { onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
