...
__decorate([
    (0, typeorm_1.OneToMany)(() => cart_item_1.CartItem, cItem => cItem.prodid),
    __metadata("design:type", Array)
], Product.prototype, "cItem", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => order_item_1.OrderItem, oItem => oItem.prodid),
    __metadata("design:type", Array)
], Product.prototype, "oItem", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_1.User, user => user.prodId, { onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
