...
__decorate([
    (0, typeorm_1.ManyToOne)(() => order_1.Order, order => order.oItem, { onUpdate: 'CASCADE', onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'orderid' }),
    __metadata("design:type", order_1.Order)
], OrderItem.prototype, "orderid", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => product_1.Product, prod => prod.cItem, { onDelete: 'SET NULL', onUpdate: 'CASCADE' }),
